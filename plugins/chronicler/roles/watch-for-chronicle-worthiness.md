...
> "This seems chronicle-worthy - you've completed the authentication flow. Consider running `/chronicler:capture topic:feature` to save this context."

Before a context switch:
> "Before switching tasks, this seems chronicle-worthy. Consider running `/chronicler:capture` to preserve where you left off."

After a key decision:
> "This architecture decision seems chronicle-worthy. Consider running `/chronicler:capture topic:planning` to document the rationale."
