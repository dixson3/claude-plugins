...
When invoked with `/chronicler:disable`:
...
- Continue capturing with `/chronicler:capture`
- Generate diaries with `/chronicler:diary`
- Recall won't show disabled chronicles (they're closed)

## Difference from Diary

| Action | `/chronicler:diary` | `/chronicler:disable` |
|--------|---------------------|----------------------|
