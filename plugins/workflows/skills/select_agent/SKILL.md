...
- Called by `/workflows:plan_to_beads` for each created task
- Called by `/workflows:breakdown_task` for each new child task
- Can be invoked directly: `/workflows:select_agent <task_id>`
