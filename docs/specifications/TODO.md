...
| TODO-034 | E2E validation of issue capture → process → submit pipeline with real GitHub tracker | P2 | Plan 50 (issue tracking) | Open | |
| TODO-035 | E2E validation of tracker-detect.sh in a project with GitLab remote | P3 | Plan 50 (issue tracking) | Open | |
| TODO-036 | `issue_config` skill for interactive tracker setup (deferred from Plan 50) | P3 | Plan 50 (deferred) | Deferred | |
| TODO-037 | `issue_migrate` skill to move issues between tracker backends (deferred from Plan 50) | P3 | Plan 50 (deferred) | Deferred | |
| TODO-038 | Linear and Jira tracker backends for `tracker-api.sh` (deferred from Plan 50) | P3 | Plan 50 (deferred) | Deferred | |
| TODO-039 | `default_labels` config for issue creation (deferred from Plan 50) | P3 | Plan 50 (deferred) | Deferred | |
