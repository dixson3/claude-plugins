...
- **yf** (v2.19.0) — Yoshiko Flow — plan lifecycle, swarm execution, context persistence, diary generation, specification artifacts, and standards-driven code generation
