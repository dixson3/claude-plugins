...
- **yf** (v2.18.1) — Yoshiko Flow — plan lifecycle, swarm execution, context persistence, diary generation, specification artifacts, and standards-driven code generation
